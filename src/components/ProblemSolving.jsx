                        ...
                        >
                            ...
                            <div className={styles.section}>
                                <h4 className={styles.sectionLabel}>
                                    <Icon name="exclamation-triangle" size={16} className={iconStyles.iconInline} />
                                    ปัญหาที่พบ
                                </h4>
                            ...
                            <div className={styles.section}>
                                <h4 className={styles.sectionLabel}>
                                    <Icon name="magnifying-glass" size={16} className={iconStyles.iconInline} />
                                    สาเหตุ
                                </h4>
                            ...
                            <div className={styles.section}>
                                <h4 className={styles.sectionLabel}>
                                    <Icon name="check-circle" size={16} className={iconStyles.iconInline} />
                                    วิธีแก้ไข
                                </h4>
